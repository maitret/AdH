...
if ($(".btn")[0] && (Waves.init(), Waves.attach(".btn")),
$(".data-table")[0]) {
...
dom: "Blfrtip",
buttons: [{extend: "excelHtml5", title: "Exportar"}, {
extend: "csvHtml5",
title: "Exportar"
}, {extend: "print", title: "Listado"}],
...
$(this).closest(".dataTables_wrapper").prepend('<div class="dataTables_buttons hidden-sm-down actions"><span class="actions__item zmdi zmdi-print" data-table-action="print" /><span class="actions__item zmdi zmdi-fullscreen" data-table-action="fullscreen" /><div class="dropdown actions__item"><i data-toggle="dropdown" class="zmdi zmdi-download" /><ul class="dropdown-menu dropdown-menu-right"><a href="" class="dropdown-item" data-table-action="excel">Excel (.xlsx)</a><a href="" class="dropdown-item" data-table-action="csv">CSV (.csv)</a></ul></div></div>')
    ...
    if ($(".color-picker")[0] && ($(this).each(function () {
            ...
            $(this).find(".color-picker__value").colorpicker({horizontal: a})
            ...
            autogrow: !0,
            btns: [["viewHTML"], ["formatting"], ["link"], ["insertImage"], "btnGrp-justify", "btnGrp-lists", ["horizontalRule"], ["removeformat"], ["fullscreen"]]
        }), $(".lightbox")[0] && $(".lightbox").lightGallery({enableTouch: !0}), $('[data-toggle="popover"]')[0] && $('[data-toggle="popover"]').popover(), $('[data-toggle="tooltip"]')[0] && $('[data-toggle="tooltip"]').tooltip(), $(".widget-calendar__body")[0]) {
        $(".widget-calendar__body").fullCalendar({
            ...
            editable: !0,
            events: [{title: "Dolor Pellentesque", start: "2016-08-01", className: "bg-cyan"}, {
                title: "Purus Nibh",
                start: "2016-08-07",
                className: "bg-amber"
        ...
        var i = moment().format("YYYY"), j = moment().format("dddd, MMM D");
